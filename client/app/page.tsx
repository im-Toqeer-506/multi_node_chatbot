          ...
          try {
            ...
            if (data.type === 'checkpoint') {
              ...
              try {
                ...
                const parsedUrls: unknown = typeof data.urls === 'string' ? JSON.parse(data.urls) : data.urls;
                const urls: string[] = Array.isArray(parsedUrls)
                  ? parsedUrls.filter((url): url is string => typeof url === 'string')
                  : [];
